...
void loop()
{
  distancia = 0.01723 * readUltrasonicDistance(1, 1); //le da un valor a la variable distancia
  if (distancia < 150) { //condición que dice que si la distancia es mayor a 150 cm
